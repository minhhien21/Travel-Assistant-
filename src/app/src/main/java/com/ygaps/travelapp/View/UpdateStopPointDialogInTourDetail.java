...
public class UpdateStopPointDialogInTourDetail extends AppCompatDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (getDialog() != null && getDialog().getWindow() != null) {
            ...
            UpdateStopPointInformationFragment stopPointDialogTab1 = new UpdateStopPointInformationFragment();
